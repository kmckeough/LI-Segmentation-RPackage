#' Count Matching Adjacent Values
#'
#' This function takes a matrix and calculates the number of matching adjacent
#' pixels.
#'
#' @param Z a matrix or array
#' @return A matrix of count values
#' @export


countNotAdjacent<-function(Z){
